...
INSERT INTO `question` (`id`, `category`, `name`, `questionType`, `question`, `status`) VALUES
(1, 1, 'Outsource is a major factor that undercut the salary of IT jobs in Hong Kong', 'multichoice', 0, 0),
(2, 1, 'Off-shore is a major factor for the shortage IT workforce in Hong Kong', 'multichoice', 0, 0),
(3, 1, 'Globalization is one of the reason of rich-poor divided in the developed country', 'multichoice', 0, 0),
(4, 1, 'Big remuneration gap for ITP is very common in the developed country', 'multichoice', 0, 0),
(5, 1, 'To most of employers, technical competence of their staff is more important than morality', 'multichoice', 0, 0),
(6, 2, 'CPD and professional membership status can guarantee the career path of an IT Professional.', 'multichoice', 0, 0),
(7, 2, 'CPD is one of the keys to sustain the competitive advantage of an IT professional.', 'multichoice', 0, 0),
(8, 2, 'Life Long Learning is equivalent to Continuous Professional Development to most of ITPs', 'multichoice', 0, 0),
(9, 2, 'Many professional bodies have mandatory CPD hours for their members.', 'multichoice', 0, 0),
(10, 2, 'Mentoring Higher Diploma students is an example of CPD for an ITP.', 'multichoice', 0, 0);
...
CREATE TABLE `question_multichoice` (
  ...
  `questionAnswer` varchar(500) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `question_multichoice` (`id`, `question`, `answerA`, `answerB`, `answerC`, `answerD`, `questionAnswer`, `status`) VALUES
(1, 1, 'True', 'False', 'All of above', 'None of above', 'answerA', 0),
(2, 2, 'True', 'False', 'All of above', 'None of above', 'answerB', 0),
(3, 3, 'True', 'False', 'All of above', 'None of above', 'answerA', 0),
(4, 4, 'True', 'False', 'All of above', 'None of above', 'answerA', 0),
(5, 5, 'True', 'False', 'All of above', 'None of above', 'answerF', 0),
(6, 6, 'True', 'False', 'All of above', 'None of above', 'answerB', 0),
(7, 7, 'True', 'False', 'All of above', 'None of above', 'answerA', 0),
(8, 8, 'True', 'False', 'All of above', 'None of above', 'answerB', 0),
(9, 9, 'True', 'False', 'All of above', 'None of above', 'answerA', 0),
(10, 10, 'True', 'False', 'All of above', 'None of above', 'answerA', 0);
...
(1, 'Quiz 1', '', '2007-09-23 02:10:10', '2007-09-23 02:10:10', 3, 120, '2018-01-05 09:43:06', 0),
(2, 'IT exam', '', '2007-09-23 02:10:10', '2007-09-23 02:10:10', 3, 120, '2018-01-05 09:43:06', 0),
(3, 'Network IQ test', '', '2007-09-23 02:10:10', '2007-09-23 02:10:10', 3, 120, '2018-01-05 09:43:06', 0);
...
(448, 'admin', 'admin', 'admin', 'admin', 0, 0, 999999999);
...
ALTER TABLE `quiz_assignment`
  ADD PRIMARY KEY (`id`) USING BTREE,
  ADD KEY `quiz` (`quiz`) USING BTREE,
  ADD KEY `groups` (`groups`) USING BTREE,
